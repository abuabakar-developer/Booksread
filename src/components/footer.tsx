  ...
  return (
    <footer className="relative bg-gray-900 text-white py-16 md:py-24">
      ...
      <div className="flex justify-center space-x-6 mt-12">
        <a href="https://github.com/abuabakar-developer/booksstore" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors duration-300">
          <FaGithub size={32} />
        </a>
